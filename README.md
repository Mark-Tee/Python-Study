...
2. [注释与输出函数](#2-注释与输出函数)
3. [变量与标识符](#3-变量与标识符)
4. [数值类型、字符串与格式化输出](#4-数值类型字符串与格式化输出)
5. [算数与赋值运算符](#5-算数与赋值运算符)
6. [输入函数与转义字符](#6-输入函数与转义字符)
7. [if 判断、比较运算符与逻辑运算符](#7-if-判断比较运算符与逻辑运算符)
8. [if-else、if-elif 与 if 嵌套](#8-if-elseif-elif-与-if-嵌套)
9. [while 循环与循环嵌套](#9-while-循环与循环嵌套)
10. [for 循环与 break、continue](#10-for-循环与-breakcontinue)
11. [字符串编码与常见操作](#11-字符串编码与常见操作)
12. [字符串的查找、判断、修改](#12-字符串的查找判断修改)
13. [列表、列表推导式、列表嵌套](#13-列表列表推导式列表嵌套)
14. [元组](#14-元组)
15. [字典](#15-字典)
16. [集合](#16-集合)
17. [函数基础](#17-函数基础)
18. [速查表与常见面试题](#18-速查表与常见面试题)
